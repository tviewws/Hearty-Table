...
export function Home() {
  return (
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F2EFE9' }}>
      ...
      {/* ── HAIRLINE ── */}
      <div className="w-full h-px" style={{ backgroundColor: '#C8C4BE' }} />
      ...
      <div
        className="mx-auto"
        style={{ width: '80px', height: '1px', backgroundColor: '#C8C4BE' }}
      />

      {/* ── GATHER ── */}
      <section className="w-full py-20 md:py-40 px-4 md:px-8" style={{ backgroundColor: '#1E1E1C' }}>
      ...
      {/* ── INGREDIENT GALLERY (no labels) ── */}
      <section className="py-16 md:py-32 px-4 md:px-8" style={{ backgroundColor: '#F2EFE9' }}>
