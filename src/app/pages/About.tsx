...
// Import the local asset from the root assets folder
...
export function About() {
  return (
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F2EFE9' }}>
      ...
      {/* ── HERO — full bleed, title overlapping bottom edge ── */}
      <section className="relative w-full overflow-hidden -mt-24" style={{ height: '80vh' }}>
        ...
        {/* bottom-aligned text */}
        <div
          className="absolute inset-0 flex flex-col justify-end px-12 pb-0"
        >
          <p
            style={{
          ...
          <h1
            style={{
              ...
              fontWeight: 300,
              lineHeight: 0.9,
              /* bleed into cream section below */
              marginBottom: '-0.12em',
              position: 'relative',
              zIndex: 2,
            }}
      ...
      {/* ── INTRO PROSE — two columns ── */}
      <section className="px-4 md:px-12 pt-16 md:pt-24 pb-12 md:pb-20" style={{ borderBottom: '1px solid #C8C4BE' }}>
        <div
          className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-24"
        >
          {/* left col — opening statement */}
          <div>
            <p
              style={{
                fontFamily: 'var(--font-serif)',
      ...
      <section style={{ backgroundColor: '#1E1E1C' }}>
        <div
          className="max-w-6xl mx-auto px-4 md:px-12 grid grid-cols-1 md:grid-cols-3"
        >
          {[
            ...
            <div
              ...
              style={{
                ...
                borderBottom: i < 2 ? '1px solid #2E2E2C' : 'none',
              }}
            >
              <style>
                {`@media (min-width: 768px) {
                  .text-center:nth-child(${i + 1}) {
                    border-right: ${i < 2 ? '1px solid #2E2E2C' : 'none'} !important;
      ...
      {/* ── WHAT WE DO — asymmetric image + text ── */}
      <section className="py-16 md:py-32 px-4 md:px-12">
        <div
          className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[5fr_4fr] gap-8 md:gap-24 items-center"
        >
          ...
          <div>
            ...
            <div style={{ width: '30px', height: '1px', backgroundColor: '#C8C4Be', marginBottom: '2rem' }} />
            <p
              style={{
                fontFamily: 'var(--font-sans)',
                fontSize: '0.9rem',
      ...
      {/* ── PULL QUOTE ── */}
      <section className="py-24 px-12" style={{ borderTop: '1px solid #C8C4Be', borderBottom: '1px solid #C8C4Be' }}>
      ...
      {/* ── WHY WE EXIST — text-only editorial ── */}
      ...
      <section
        ...
        style={{ borderTop: '1px solid #C8C4Be' }}
      >
        <div className="max-w-xl mx-auto space-y-6">
          ...
          <div style={{ width: '40px', height: '1px', backgroundColor: '#C8C4Be', margin: '0 auto' }} />
          <p
            style={{
              fontFamily: 'var(--font-serif)',
              letterSpacing: '0.25em',
